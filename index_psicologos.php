    ...
    <main>
            ...
            ?>
                      <div class="caja caja3">
                        ...
                        <h4>Mis citas</h4>
                        <p>Aquí puedes ver tus citas programadas.</p>
                    ...
                    <a href="pacientes_psicologo.php?id_perfil='.$id_profesional.'">
                      <div class="caja caja4">
                      <object type="image/svg+xml" data="img/paciente.svg" class="icon icon-tabler icon-tabler-switch-3" width="52" height="52"></object>
                        <h4>Mis Pacientes</h4>
                        <p>Aquí puedes ver tus pacientes.</p>
                        <div class="animacion"></div>
                      </div>
                    </a>
                    ';

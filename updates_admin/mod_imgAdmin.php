    ...
    <?php
            ...
            $consulta_admin = mysqli_query($conection, $admin ) or die ("Error al traer los datos");
                if($consulta_perfil= mysqli_fetch_array($consulta_admin)){
                    ...
                    <form method="POST"  enctype="multipart/form-data">
                        <section class="seccion-perfil-usuario">
                            ...
                            <div class="perfil-usuario-body">
                                ...
                                <a href="../updates_admin/modificar_admin.php?id='.$id_adminm.'&id_perfil='.$id_admin.'" class="button">volver</a>
                            </div>
                        </section>
                        ';
                    ...
                    $actualizar_SQL = "UPDATE administrador SET foto_perfil='$imagen_producto' Where id_admin='$id_adminm'";
